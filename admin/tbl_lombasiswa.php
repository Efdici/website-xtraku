...
<body>
    ...
    <table width="90%" style="margin-top: 1%; margin-left: 5%;"  border="1" cellpadding="0" cellspacing="0">
        <tr bgcolor="#FFA600" height="40">
             <th width="12%"><center>Id LombaSiswa</center></th>&nbsp;
...
while ( $hasil             = mysqli_fetch_array ($Tampil)) {
     $id_lombasiswa         = stripslashes  ($hasil['id_lombasiswa']);
...
?>
        <tr align="center" height="40">
            ...
            <td><?=$id_siswa?></td>
            <td>
                <a onclick="return confirm('tekan OKE untuk menghapus')" href="hapus_lombasiswa.php?id_lombasiswa=<?php echo $hasil['id_lombasiswa'];?>" style="padding:1% 1%;background-color: #B22222;color: #fff;border-radius: 2px;text-decoration: none;">Delete</a>
                <a href="edit_lombasiswa.php?id_lombasiswa=<?php echo $hasil['id_lombasiswa'];?>" style="padding:1% 1%;background-color: #1E90FF;color: #fff;border-radius: 2px;text-decoration: none;">Update</a>
            </td>
<?php }} ?>
    </table>
</body>
